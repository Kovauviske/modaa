...
if(player distance _vehicle > 7.5) exitWith {hint "Você precisa estar mais perto do veículo!"};
...
titleText[format["Você fez o reabastecido do %1",_displayName],"PLAIN"];
