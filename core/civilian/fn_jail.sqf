...
titleText["Você foi preso, espere o tempo para sair. Se você tentar sair do jogo seu tempo irá aumentar","PLAIN"];
hint "Você foi preso por isso vai perder as licenças them\n\nFirearms License\nRebel License";
